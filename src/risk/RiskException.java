...
public class RiskException {
  ...
  public String toString() {
    return OutputBuilder
      .beginBuild()
      .autoAdd("código de error", String.valueOf(this.getCodigo()))
      .autoAdd("descripción", this.getCodigoTexto())
      .build();
  }
  ...
  public String getMessage() {
    return OutputBuilder
      .beginBuild()
      .autoAdd("código de error", this.getCodigo())
      .autoAdd("descripción", this.getCodigoTexto())
      .build();
  }
